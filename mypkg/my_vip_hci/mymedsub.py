...
from vip_hci.var import get_annulus_segments, mask_circle
...
from vip_hci.config.utils_conf import pool_map, iterable, print_precision
...
def median_sub(cube, angle_list, scale_list=None, flux_sc_list=None, fwhm=4,
    ...
    if ARRAY.ndim == 3:
        ...
        if mode == 'fullfr':
            ...
            if nframes is not None and nframes % 2 != 0:
